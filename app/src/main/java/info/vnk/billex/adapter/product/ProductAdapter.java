package info.vnk.billex.adapter.product;
...
public class ProductAdapter extends RecyclerView.Adapter<ProductAdapter.ProductViewHolder> implements Filterable {
    ...
    private List<ProductModel> orderModel;
    private List<ProductModel> filteredList;
    private List<ProductModel> duplicateList;
    ...
    public ProductAdapter(List<ProductModel> orderList, int rowLayout, Context context) {
    ...
    private class OrderFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            ArrayList<ProductModel> FilteredArrList = new ArrayList<>();
            /********
             *
            ...
            if (constraint != null && constraint.length() > 0) {
                List<ProductModel> order = duplicateList;
                for (int i = 0; i < duplicateList.size(); i++) {

                    String data = order.get(i).getPdtName();
                    String customers = order.get(i).getPdtCode();
        ...
        protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
            orderModel = (ArrayList<ProductModel>) filterResults.values;
